...
class Activity(unittest.TestCase):
    ...
    def activity_analysis_operation(self):
        ...
        self.assertTrue(self.analysis_detail.wait_check_page(), self.analysis_detail.hw_list_tips)  # 页面检查点
        self.activity.back_up_button()  # 返回 本班习题
    ...
    def per_answer_detail(self, st):
        ...
        self.game_type_judge_operation(len(item), st)  # 小游戏 类型判断 及具体操作
