...
class TimingHw(unittest.TestCase):
    ...
    def test_002_timing_hw_publish(self):
        ...
        if self.draft.wait_check_empty_tips_page():
            ...
            self.assertTrue(self.draft.wait_check_more_page, self.draft.more_tips)
            ...
            self.van.judge_vanclass_result_operation(choose, name)  # 班级中 验证布置结果
