...
class Paper(unittest.TestCase):
    ...
    def edit_paper_operation(self):
        ...
        self.assertTrue(self.report.wait_check_edit_page(), self.van_paper.edit_tips)
        self.assertTrue(self.release.wait_check_release_list_page(), self.van_paper.edit_list_tips)
        ...
        self.assertTrue(self.report.wait_check_edit_page(), self.report.edit_tips)
