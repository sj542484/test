...
from testfarm.test_program.app.honor.teacher.play_games.object_page.word_dictation_page import WordDictation
                    ...
                    if self.detail.wait_check_list_page():
                        ...
                        if self.game.wait_check_page():
                            if self.game.wait_check_list_page():
                                ...
                                self.result.result_page_correct_rate(result[2]+ result2[1][2], result[0])  # 结果页 准确率
                                print('################################################')
