...
from app.honor.teacher.play_games.object_page.strengthen_sentence_page import StrengthenSentencePage
...
class Games(unittest.TestCase):
    ...
    def test_strengthen_sentence(self):
        ...
        if self.home.wait_check_page():
            self.question.search_operation(gv.STREN_SENT)  # 进入首页后 进入题库tab，并搜索题单
            self.homework.games_operation(gv.STREN_SENT, self.game_exist, '强化炼句')  # 查找题单内 该类型的小游戏
        else:
