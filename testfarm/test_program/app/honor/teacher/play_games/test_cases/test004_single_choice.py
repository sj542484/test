...
from testfarm.test_program.app.honor.teacher.play_games.object_page.single_choice_page import SingleChoice
...
from testfarm.test_program.conf.decorator import setup, teardown, teststeps, testcase
                    ...
                    if self.detail.wait_check_list_page():
                        ...
                        if self.game.wait_check_page():
                            if self.game.wait_check_list_page():
                                ...
                                self.single.check_detail_page(result2[1][0])  # 结果页 查看答案
                                print('################################################')
