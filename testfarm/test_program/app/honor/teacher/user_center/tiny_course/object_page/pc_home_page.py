...
class HomePage(BasePage):
    ...
    def test_bank_tab(self):
        """顶部 题库tab"""
        locator = (By.XPATH, "//div[@class='nav']/a[text()='题库']")
        return self.wait.wait_find_element(locator).click()
    ...
    def commit_button(self):
        """确定 按钮"""
        locator = (By.XPATH, '//span[contains(text(),"确 定")]/parent::button')
        self.wait.wait_find_element(locator).click()
    ...
    def tips_content(self):
        """温馨提示 具体内容"""
        locator = (By.XPATH, '//div[@class="el-message-box"]/p')
        return self.wait.wait_find_element(locator)

    @teststeps
    def never_notify(self):
        """不再提醒"""
        locator = (By.XPATH, '//div[@class="el-message-box"]/p/span')
        return self.wait.wait_find_element(locator)
