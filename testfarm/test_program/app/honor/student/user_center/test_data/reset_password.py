...
reset_pwd = (
    {'old': '456789', 'new': ' ', 'commit': ' ', 'assert': ' 密码 格式不正确'},  # 1个空格
    {'old': '456789', 'new': '      ', 'commit': '      '},  # 多个空格 -6个
    {'old': '456789', 'new': '', 'commit': ''},  # 为空
    {'old': '456789', 'new': '180we', 'commit': '180we'},   # 少于6个字符 - 5位
    {'old': '456789', 'new': '456789342423443213423', 'commit': '456789342423443213423'},  # 多于20个字符 - 21个数字
    {'old': '456789', 'new': 'VANTHINKvanthinkstude', 'commit': 'VANTHINKvanthinkstude'},  # 多于20个字符 - 21个字母
    {'old': '456789', 'new': '456789sfsfwrzxcsad1sa', 'commit': '456789sfsfwrzxcsad1sa'},  # 多于20个字符 - 21个数字、字母组合
    {'old': '456789', 'new': 'q12a z.w@S勿x', 'commit': 'q12a z.w@S勿x'},  # 中文、数字、英文、大写字母、空格、@、'.'字符组合
