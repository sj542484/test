...
from testfarm.test_program.app.honor.student.word_book.object_page.vocabulary_choose_page import VocabularyChoose
from testfarm.test_program.app.honor.student.word_book.object_page.word_dictation_page import WordDictation
from testfarm.test_program.app.honor.student.word_book.object_page.word_match_page import MatchingWord
...
class WordBook(BasePage):
    ...
    def wait_check_no_word_page(self):
        ...
        locator = (By.XPATH,
                   ...
                   "'{}status_error_hint_view')]".format(self.id_type()))
        try:
            WebDriverWait(self.driver, 5, 0.5).until(lambda x: x.find_element(*locator))
            return True
        except:
